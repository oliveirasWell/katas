...
describe('TennisScoreCalculator', () => {
  describe('should correctly calculate the score for a game in progress', () => {
    it.each([
      ...
      { player1Points: 4, player2Points: 0, expected: 'Win for Player 1' },
      ...
      { player1Points: 0, player2Points: 4, expected: 'Win for Player 2' },

      { player1Points: 3, player2Points: 3, expected: 'Deuce' },
      { player1Points: 4, player2Points: 4, expected: 'Deuce' },

      { player1Points: 3, player2Points: 2, expected: 'Forty-Thirty' },
      { player1Points: 2, player2Points: 3, expected: 'Thirty-Forty' },

      { player1Points: 3, player2Points: 4, expected: 'Advantage Player 2' },
      { player1Points: 4, player2Points: 5, expected: 'Advantage Player 2' },
      { player1Points: 5, player2Points: 4, expected: 'Advantage Player 1' },
